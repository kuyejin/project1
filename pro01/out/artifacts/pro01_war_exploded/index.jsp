...
<head>
    ...
    <link rel="stylesheet" href="<%=path2 %>/css/hd.css">
    <link rel="stylesheet" href="<%=path2 %>/css/contents.css">
    <link rel="stylesheet" href="<%=path2 %>/css/ft.css">
</head>
                    ...
                    <ul class="card_lst">
                        ...
                        <li class="item2">
                            <a href="">
                                ...
                                <p class="thumb_tit">썸네일제목2 썸네일제목2 썸네일제목2 썸네일제목2 썸네일제목2 썸네일제목2 썸네일제목2썸네일제목2 썸네일제목2
                                    썸네일제목2
